# نصب و مدیریت Ocserv با پنل مدیریت پیشرفته
...
- ✅ پنل مدیریت گرافیکی با رابط کاربری جذاب
...
بعد از نصب، می‌توانید با دستور زیر به پنل مدیریت دسترسی پیدا کنید:
```bash
sudo oc-p
```
...
نکات مهم SSL:
- تمدید خودکار گواهی پیکربندی می‌شود
